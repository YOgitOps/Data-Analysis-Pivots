# Data-Analysis-Pivots
This project delivers an end-to-end business intelligence solution that evaluates revenue performance, customer dynamics, and product-line profitability. Designed as decision-support system in real time, the accompanying interactive dashboard translates sales data into strategic insights across product categories, and temporal performance metrics.
Business Problem & Key Objectives
•Identify the highest-value product line.
